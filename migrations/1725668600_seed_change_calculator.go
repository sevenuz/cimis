...
var changeCalculatorTranslations = map[string][2]string{
	"ui_reset":      {"Zurücksetzen", "Reset"},
	"ui_change_due": {"Wechselgeld", "Change due"},
}
...
func init() {
	m.Register(func(db dbx.Builder) error {
		...
		for name, t := range changeCalculatorTranslations {
